...
$(function() {
  ...
  */
   describe('Rétt vinnumat íslenskukennara', function() {
    it("Ársæll", function() {
      var kennari = new Kennari('Ársæll')
      var a = new Afangi(['Ísl 103', 3, 23,'Íslenska, neðra þrep']);
      var b = new Afangi(['Ísl 193', 3, 17,'Almenn braut']);
      var c = new Afangi(['Ísl 203', 3, 28,'Íslenska, efra þrep']);
      var d = new Afangi(['Ísl 403', 3, 19,'Íslenska, efra þrep']);
      kennari.addAfangi(a);
      kennari.addAfangi(b);
      kennari.addAfangi(c);
      kennari.addAfangi(d);
      kennari.ryra();
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-182.32)).toBeLessThan(0.1);
      //expect(Math.abs(kennari.originalAfangar[1].vinnumat()-178.89)).toBeLessThan(0.1);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-199.67)).toBeLessThan(0.1);
      expect(Math.abs(kennari.originalAfangar[3].vinnumat()-175.64)).toBeLessThan(0.1);
  ...
  */
   describe('Rétt vinnumat félagsfræðikennara', function() {
    it("Aðalbjörg", function() {
      var kennari = new Kennari('Aðalbjörg')
      var a = new Afangi(['HBF 103', 3, 19,'Félagsgreinar, neðra þrep']);
      var b = new Afangi(['Sas 103', 3, 15,'Félagsgreinar, neðra þrep']);
      var c = new Afangi(['Sas 103', 3, 16,'Félagsgreinar, neðra þrep']);
      kennari.addAfangi(a);
      kennari.addAfangi(b);
      kennari.addAfangi(c);
      kennari.ryra();
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-167.5)).toBeLessThan(0.1);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-156)).toBeLessThan(0.1);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-156)).toBeLessThan(0.1);
  ...
  */
   describe('Rétt vinnumat sögukennara', function() {
    it("Arngrímur (óskertur)", function() {
      var kennari = new Kennari('Arngrímur')
      var a = new Afangi(['saga2SN05a', 3, 18,'Félagsgreinar, efra þrep']);
      var b = new Afangi(['saga2SN05', 3, 23,'Félagsgreinar, efra þrep']);
      var c = new Afangi(['saga3MM05a', 3, 20,'Félagsgreinar, efra þrep']);
      var d = new Afangi(['saga3MM05', 3, 24,'Félagsgreinar, efra þrep']);
      var e = new Afangi(['sagaMA05', 3, 15,'Félagsgreinar, efra þrep']);
      ...
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-170.1)).toBeLessThan(0.1);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-183.4)).toBeLessThan(0.1);
      expect(Math.abs(kennari.originalAfangar[4].vinnumat()-167.4)).toBeLessThan(0.1);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()*0.5-87.7)).toBeLessThan(0.1);
      expect(Math.abs(kennari.originalAfangar[3].vinnumat()*0.5-93)).toBeLessThan(0.1);
    });
  });
  /*
  * Test 28: 
  */
   describe('Rétt vinnumat stærð/raun kennara', function() {
    it("Unnar (óskertur)", function() {
      var kennari = new Kennari('Unnar')
      var a = new Afangi(['a', 3, 15,'Raungreinar, efra þrep']);
      var b = new Afangi(['b', 3, 15,'Stærðfræði, efra þrep']);
      var c = new Afangi(['c', 3, 25,'Stærðfræði, efra þrep']);
      var d = new Afangi(['d', 3, 11,'Stærðfræði, efra þrep']);
      ...
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-165.55)).toBeLessThan(0.1);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-161.39)).toBeLessThan(0.1);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-182.75)).toBeLessThan(0.1);
      expect(Math.abs(kennari.originalAfangar[3].vinnumat()-161.39)).toBeLessThan(0.1);
    });
  });
  /*
  * Test 29: 
  */
   describe('Rétt vinnumat listgreinakennara', function() {
    it("Gréta", function() {
      var kennari = new Kennari('Gréta')
      var a = new Afangi(['a', 3, 19,'Listgreinar, efra þrep']);
      var b = new Afangi(['b', 3, 19,'Listgreinar, neðra þrep']);
      var c = new Afangi(['c', 3, 12,'Listgreinar, efra þrep']);
      var d = new Afangi(['d', 3, 24,'Félagsgreinar, efra þrep']);
      ...
      kennari.addAfangi(d);
      kennari.ryra();
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-189.4)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-187)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-168.04)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[3].vinnumat()-186.2)).toBeLessThan(0.5);
    });
  });
  /*
  * Test 30: 
  */
   describe('Rétt vinnumat raungreinakennara', function() {
    it("Guðrún Ingibjörg", function() {
      var kennari = new Kennari('Guðrún Ingibjörg')
      var a = new Afangi(['efn 103', 3, 17,'Raungreinar, efra þrep']);
      var b = new Afangi(['efn 203', 3, 19,'Raungreinar, efra þrep']);
      var c = new Afangi(['nær 103', 3, 26,'Almennar raungreinar']);
      var d = new Afangi(['nær 103', 3, 31,'Almennar raungreinar']);
      ...
      kennari.addAfangi(d);
      kennari.ryra();
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-170.84)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-176.18)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-173.76)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[3].vinnumat()-189.12)).toBeLessThan(0.5);
    });
  });
  /*
  * Test 31: 
  */
   describe('Rétt vinnumat fagbóklegs kennara', function() {
    it("Guðrún K.", function() {
      var kennari = new Kennari('Guðrún K.')
      var a = new Afangi(['a', 3, 3,'Fagbóklegt']);
      var b = new Afangi(['b', 3, 3,'Fagbóklegt']);
      var c = new Afangi(['c', 3, 15,'Fagbóklegt']);

      kennari.addAfangi(a);
      kennari.addAfangi(b);
      kennari.addAfangi(c);
      kennari.ryra();
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-161.2)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-161.2)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-174.55)).toBeLessThan(0.5);
    });
  });
  /*
  * Test 32: 
  */
   describe('Rétt vinnumat félagsgreina kennara', function() {
    it("Hannes Ísberg", function() {
      var kennari = new Kennari('Guðrún K.')
      var a = new Afangi(['a', 3, 22,'Félagsgreinar, neðra þrep']);
      var b = new Afangi(['b', 3, 25,'Félagsgreinar, efra þrep']);
      var c = new Afangi(['c', 3, 20,'Félagsgreinar, efra þrep']);

      kennari.addAfangi(a);
      kennari.addAfangi(b);
      kennari.addAfangi(c);
      kennari.ryra();
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-175)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-188.9)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-175.4)).toBeLessThan(0.5);
    });
  });
  /*
  * Test 33: 
  */
   describe('Rétt vinnumat íslenskukennara', function() {
    it("Helgi Sæm.", function() {
      var kennari = new Kennari('Helgi Sæm.')
      var a = new Afangi(['a', 3, 21,'Erlend mál, neðra þrep']);
      var b = new Afangi(['b', 3, 31,'Íslenska, efra þrep']);
      var c = new Afangi(['c', 3, 21,'Íslenska, efra þrep']);

      kennari.addAfangi(a);
      kennari.addAfangi(b);
      kennari.addAfangi(c);
      kennari.ryra();
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-172.5)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-211.4)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-180.98)).toBeLessThan(0.5);
    });
  });
  /*
  * Test 34: 
  */
   describe('Rétt vinnumat enskukennara (þrískert)', function() {
    it("Herdís", function() {
      var kennari = new Kennari('Herdís')
      var a = new Afangi(['a', 3, 21,'Erlend mál, efra þrep']);
      var b = new Afangi(['a', 3, 22,'Erlend mál, efra þrep']);
      var c = new Afangi(['c', 3, 17,'Erlend mál, neðra þrep']);
      var d = new Afangi(['a', 3, 21,'Erlend mál, efra þrep']);
      ...
      kennari.addAfangi(d);
      kennari.ryra();
      var s = Math.abs(kennari.originalAfangar[0].vinnumat());
      s += Math.abs(kennari.originalAfangar[1].vinnumat());
      s += Math.abs(kennari.originalAfangar[3].vinnumat());
      expect(Math.abs(s-508)).toBeLessThan(0.5);
    });
  });
  ...
  */
   describe('Rétt vinnumat stærðfræðikennara', function() {
    it("Jónína", function() {
      var kennari = new Kennari('Jónína')
      var a = new Afangi(['a', 3, 20,'Stærðfræði, efra þrep']);
      var b = new Afangi(['b', 3, 26,'Almenn braut']);
      var c = new Afangi(['c', 3, 24,'Stærðfræði, efra þrep']);
      var d = new Afangi(['d', 3, 21,'Stærðfræði, efra þrep']);
      var e = new Afangi(['e', 3, 30,'Stærðfræði, neðra þrep']);
  ...
  */
   describe('Rétt vinnumat raungreinakennara', function() {
    it("Líney", function() {
      var kennari = new Kennari('Líney')
      var a = new Afangi(['a', 3, 19,'Raungreinar, neðra þrep']);
      var b = new Afangi(['b', 3, 20,'Raungreinar, neðra þrep']);
      var c = new Afangi(['c', 3, 19,'Almennar raungreinar']);
      var d = new Afangi(['c', 3, 21,'Almennar raungreinar']);
      ...
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-171)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-173.5)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-156.96)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[3].vinnumat()-161.76)).toBeLessThan(0.5);
    });
  });
  /*
  * Test 37: 
  */
   describe('Rétt vinnumat íslenskukennara', function() {
    it("Vala", function() {
      var kennari = new Kennari('Vala')
      var a = new Afangi(['a', 3, 20,'Íslenska, efra þrep']);
      var b = new Afangi(['b', 3, 25,'Íslenska, efra þrep']);
      var c = new Afangi(['c', 3, 22,'Íslenska, neðra þrep']);
      var d = new Afangi(['a', 3, 15,'Íslenska, efra þrep']);
      ...
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-171.1776)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-191.66)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-179.65)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[3].vinnumat()-163.48)).toBeLessThan(0.5);
    });
  });
  /*
  * Test 38: 
  */
   describe('Kennari í heilbrigðisskóli', function() {
    it("Inga", function() {
      var kennari = new Kennari('Inga')
      var a = new Afangi(['a', 3, 16,'Almennar raungreinar']);
      var b = new Afangi(['b', 3, 17,'Fagbóklegt']);
      var c = new Afangi(['c', 3, 12,'Verklegt']);
      var d = new Afangi(['a', 3, 26,'Almennar raungreinar']);
      var e = new Afangi(['c', 3, 12,'Verklegt']);
      ...
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-152.16)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-179.89)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-167.8)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[3].vinnumat()-173.76)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[4].vinnumat()-167.712)).toBeLessThan(0.5);
  ...
  */
   describe('Frönskukennari rétt vinnumat', function() {
    it("Ingunn", function() {
      var kennari = new Kennari('Ingunn')
      var a = new Afangi(['a', 3, 20,'Erlend mál, neðra þrep']);
      var b = new Afangi(['b', 3, 17,'Erlend mál, neðra þrep']);
      var c = new Afangi(['c', 3, 14,'Erlend mál, neðra þrep']);
      var d = new Afangi(['d', 3, 10,'Erlend mál, efra þrep']);
      var e = new Afangi(['e', 3, 11,'Erlend mál, efra þrep']);
      ...
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-170)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-162.5)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-162.5)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[3].vinnumat()-167.3)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[4].vinnumat()-167.3)).toBeLessThan(0.5);
    });
  });
  /*
  * Test 40: 
  */
   describe('Spænskukennari rétt vinnumat', function() {
    it("Carmen", function() {
      var kennari = new Kennari('Carmen')
      var a = new Afangi(['a', 3, 17,'Erlend mál, neðra þrep']);
      var b = new Afangi(['b', 3, 25,'Erlend mál, neðra þrep']);
      var c = new Afangi(['c', 3, 6,'Erlend mál, efra þrep']);
      var d = new Afangi(['a', 3, 19,'Erlend mál, neðra þrep']);
      ...
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-156)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-182.5)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-167.3)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[3].vinnumat()-160.8)).toBeLessThan(0.5);
    });
  });
  /*
  * Test 41: 
  */
   describe('Þýskukennari rétt vinnumat', function() {
    it("Steinunn", function() {
      var kennari = new Kennari('Steinunn')
      var a = new Afangi(['a', 3, 18,'Erlend mál, neðra þrep']);
      var b = new Afangi(['b', 3, 31,'Erlend mál, neðra þrep']);
      var c = new Afangi(['c', 3, 5,'Erlend mál, efra þrep']);
      var d = new Afangi(['a', 3, 17,'Erlend mál, neðra þrep']);
      ...
      expect(Math.abs(kennari.originalAfangar[0].vinnumat()-158.4)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[1].vinnumat()-201)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[2].vinnumat()-167.3)).toBeLessThan(0.5);
      expect(Math.abs(kennari.originalAfangar[3].vinnumat()-156)).toBeLessThan(0.5);
    });
  });
}());
